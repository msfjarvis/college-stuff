// Java program to compare two strings, i.e., test whether they are equal or not, compareTo method
// of String class is used to test equality of two String class objects.
